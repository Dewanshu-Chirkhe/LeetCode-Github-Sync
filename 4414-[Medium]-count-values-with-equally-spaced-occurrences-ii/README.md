...
Example 1:
  ...
  Output: 2
  Explanation: 1 is special because it occurs at equally spaced indices 0, 2, and 4.
...
Example 2:
  Input:  nums = [8,8,8,8]
  Output: 1
  Explanation: 8 is special because it occurs at equally spaced indices 0, 1, 2, and 3. Therefore, the answer is 1.
