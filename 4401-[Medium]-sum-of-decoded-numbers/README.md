...
Example 1:
  Input:  nums = [231]
  Output: 8
  Explanation: For 231, we have width = 1, d = 23, x = 2, and y = 3.
...
Example 2:
  ...
  Output: 1649
  Explanation: For 2522, we have width = 2, d = 252, x = 25, and y = 2.
...
Example 3:
  Input:  nums = [2301]
  Output: 73741817
  Explanation: For 2301, we have width = 1, d = 230, x = 2, and y = 30.
